# Clawdbot adversarial test catalog
...
Use synthetic, licensed, or public fixtures. Preserve synthetic inputs, least-privilege tools, action logs, dependency versions, backups, and tested restores.
