# Clawdbot observability signal plan
...
Collect the smallest set of signals needed to detect harm, diagnose failure, and confirm recovery. Tie each signal to synthetic inputs, least-privilege tools, action logs, dependency versions, backups, and tested restores.
