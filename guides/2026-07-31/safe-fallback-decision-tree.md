# Clawdbot safe fallback decision tree
...
Define the ordered response for unavailable dependencies, incomplete outputs, stale evidence, policy conflicts, and exceeded cost or time limits. Base choices on synthetic inputs, least-privilege tools, action logs, dependency versions, backups, and tested restores.
